package sit.int202.ecommerce.modules.brand.controller;
...
public class BrandController {
    ...
    public ErrorResponse handleBrandHasSaleItems(BrandHasSaleItemsException ex, HttpServletRequest request) {
        return ErrorResponse.builder()
