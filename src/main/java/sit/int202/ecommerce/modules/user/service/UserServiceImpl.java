...
public class UserServiceImpl implements UserService {
    ...
    public UserAccount registerUser(RegisterRequest request, MultipartFile frontImage, MultipartFile backImage) {
        UserAccount user = userMapper.toEntityFromRegisterRequest(request);
